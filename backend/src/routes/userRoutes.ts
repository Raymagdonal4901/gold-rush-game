...
import { getLeaderboard, unlockSlot, claimNotificationReward, deleteNotification, recalculateAllUsersIncome, getReferrals, levelUpAccount } from '../controllers/userController';
...
router.post('/levelup', authenticate, levelUpAccount);
