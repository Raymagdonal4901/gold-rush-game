                ...
                isMobileMenuOpen && (
                    <div className="fixed inset-0 z-[100] bg-black/95 backdrop-blur-xl flex flex-col p-6 animate-in slide-in-from-bottom-10 duration-300 lg:hidden">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <button onClick={() => { setIsReferralOpen(true); setIsMobileMenuOpen(false); }} className="bg-stone-900 p-4 rounded-xl border border-stone-800 flex flex-col items-center gap-2 hover:bg-stone-800 active:scale-95 transition-all"><Users className="text-blue-500" size={32} /><span className="text-sm font-bold text-stone-300">ชวนเพื่อน</span></button>
                            ...
                            <button onClick={() => { setIsGiftSystemOpen(true); setIsMobileMenuOpen(false); }} className="bg-stone-900 p-4 rounded-xl border border-stone-800 flex flex-col items-center gap-2 hover:bg-stone-800 active:scale-95 transition-all"><Gift className="text-pink-400" size={32} /><span className="text-sm font-bold text-stone-300">ของขวัญ</span></button>
                            ...
                            <button onClick={() => { setIsDevToolsOpen(true); setIsMobileMenuOpen(false); }} className="bg-stone-900 p-4 rounded-xl border border-red-900/30 flex flex-col items-center gap-2 hover:bg-stone-800 active:scale-95 transition-all"><Bug className="text-red-500" size={32} /><span className="text-sm font-bold text-stone-300">Test System</span></button>
                        </div>
