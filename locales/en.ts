export const en = {
    ...
    admin: {
        title: "ADMIN PANEL",
        subtitle: "MINE CONTROL CENTER",
        title_summary: "SYSTEM SUMMARY",
        pending_requests: "PENDING REQUESTS",
        total_users: "TOTAL USERS",
        system_balance: "SYSTEM BALANCE",
        revenue_analytics: "REVENUE ANALYTICS",
        player_view: "PLAYER VIEW",
        setup_qr: "QR CODE SETUP",
        setup_qr_desc: "UPLOAD DEPOSIT QR CODE",
        ...
        approve: "APPROVE",
        unban_confirm: "UNBAN",
        ban_confirm: "BAN USER",
        reset_confirm: "RESET DATA",
        remove_vip_confirm: "REMOVE VIP",
        reset_password: "RESET PASSWORD",
        financial_audit: "FINANCIAL AUDIT",
        profitability: "PROFITABILITY",
        total_mined: "TOTAL MINED",
        free_income: "FREE INCOME",
